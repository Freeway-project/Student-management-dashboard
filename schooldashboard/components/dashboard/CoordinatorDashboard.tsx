...
import { CheckSquare, Clock, AlertCircle, Upload, File, X, RefreshCw, Plus, Users } from 'lucide-react';
...
export default function CoordinatorDashboard() {
  ...
  const fetchTasks = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // console.log('🚀 ~ :98 ~ fetchTasks ~ data::==', data)

        const tasks = data.tasks || [];

        // console.log('🚀 ~ :102 ~ fetchTasks ~ tasks::==', tasks)
  ...
  }).filter(u => ['TEACHER', 'PROFESSOR'].includes(u.role));
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage your tasks and monitor your team's progress</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <TabsContent value="team-tasks">
              {teamTasks.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">No tasks assigned to your team</p>
                </div>
              ) : (
                <div className="space-y-4">
      ...
      {/* Task Detail Modal - Same as TeacherDashboard */}
      {selectedTask && (
